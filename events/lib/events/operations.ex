defmodule Events.Operation do
  ...
  @event_open_code 1000.0
  @event_session_code 1100.0
  ...
  def upsert(@event_open_code, _parent_id, _date, _value, _with_session), do: { :error }
  ...
  def upsert(@event_session_code, _parent_id, _date, _value, _with_session), do: { :error }

  def find_clause(parent_id, date) do
