defmodule MigrationTest do
  ...
  test "it correctly iterates through cursor. app session mock" do
    ...
    :meck.expect(File, :write, fn(_, csv, _) ->
      assert csv == "666f6f,626172,,1000,2012-11-04 10:15:23,100,,\n666f6f,626172,,1000,2012-11-04 10:15:23,100,,\n"
    end)
  ...
  test "it correctly iterates through cursor. app open mock" do
    ...
    :meck.expect(File, :write, fn(_, csv, _) ->
      assert csv == "666f6f,626172,,1100,2012-11-04 10:15:23,100,,\n666f6f,626172,,1100,2012-11-04 10:15:23,100,,\n"
    end)
